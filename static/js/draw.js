var draw = JSON.parse(draw);

var draw_len = draw['image'].length;
...
pag = Math.ceil(draw_len/img_page);
...
for (i = 0; i < draw_len; i++) {
    ...
    $('#r' + rx + px + '').append(
        '<div class="col-lg-2 col-md-4 col-sm-4 col-xs-6">' +
                '<a href="#image' + i + '">' +
                    '<img class="thumbnail img-responsive" src="' + draw.image[i].linkSmall + '">' +
                '</a>' +
